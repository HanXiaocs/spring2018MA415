...
##summary
```{r}
#sum_each_year <- apply(datas, MARGIN = 1, FUN = 'sum')
#sum_each_year <- ts(datas)
#sum_each_year
#data11 <- read.table(pipe("pbpaste"), sep="\t", header=T)
#datas2 = apply(t(datas),1,rev) 
ts2 <- as.vector(t(datas2))
#ts2
ts3 <- ts(ts2,frequency = 13,start = c(2000,10))#, start = c(2000,10), frequency=12)ts3
#ts3
